...
let processData = [
    ...
    Process(id: nil, sort_id: nil, group: "edgeserv", name: "edgeserv", pid: nil, state: Int64(Constants.ProcessStates.FATAL), start: nil, cpu: pointArray("yhoo"), memory: pointArray("aapl"), server_id: nil),
